...
var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            // Calculate percentage exp out of income
        ...
        getPercentages: function() {
            var allPerc = data.allItems.exp.map(function(cur) {
                return cur.getPercentage(); //***************or getPercentages? */
            });
            return allPerc;
        },

        getBudget: function() { // Will ONLY return the data
            return {
                budget: data.budget,
        ...
        // Useful to create a testing function to view your data
        testing: function() {
            console.log(data);
        }
    };
...
var UIController = (function() {
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            // Insert HTML into DOM using insertAdjacentHTML(position, text)
        ...
        clearFields: function() {
            ...
            fieldsArray.forEach(function(current, index, array) { // up to three arguments
                current.value = '';
            });
            fieldsArray[0].focus();
        },
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            type = splitID[0];
            ID = parseInt(splitID[1]); // Needed to convert from string to integer
